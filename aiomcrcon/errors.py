...
class ClientNotConnectedError(Exception):
    ...
    def __init__(self) -> None:
        super().__init__("The client isn't connected. (Looks like you forgot to call the connect() coroutine!)")
...
class IncorrectPasswordError(Exception):
    ...
    def __init__(self) -> None:
        super().__init__("The password provided to the client was incorrect according to the server.")
